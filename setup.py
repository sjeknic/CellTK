...
setuptools.setup(
    ...
    install_requires=[
        'setuptools>=41.2.0',
        'tensorflow>=2.7.0,<2.10.0 ; platform_machine != "arm64"',  # should tensorflow be optional?
        'tensorflow-macos>=2.7.0,<2.10.0 ; platform_machine == "arm64"',
        ...
        # 'napari>=0.4.12',  # Is this only required for btrack?
        'PyYAML>=6.0',
        'SimpleITK>=2.1.1',
        'tifffile>=2021.11.2',
        'colorcet~=3.0.0',  # for glasbey colormap
        'seaborn~=0.11.2'
    ],
    extras_require = {
        'test': ['pytest>=7.0', 'ipdb>=0.13'],
        'btrack': ['btrack==0.4.2'],  # lbep not found with 0.4.5, fix later (20220925)
        'kit': ['gurobipy>=9.5.0', 'kvxopt~=1.3.0.2']
    },
    python_requires=">=3.9",
)